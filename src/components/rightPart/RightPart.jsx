...
function RightPart() {
  return (
    <div className="col-span-3 items-start justify-start flex flex-col w-full pt-12 pb-6">
      {/* top section */}
      <div className="flex items-center justify-center w-full space-x-4  px-12">
      ...
      {/* bottom part */}
      <div className="w-full items-start justify-start flex flex-col px-12 py-6">
        <h1 className="text-xl font-bold xl:text-3xl"> My Portfolio </h1>
        <div className="flex items-center justify-center space-x-6 overflow-x-auto scrollbar-hide">
          {InvestDB.map((item) => (
